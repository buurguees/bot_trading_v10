    ...
    def _load_config(self) -> Dict[str, Any]:
        ...
        try:
            return {
                ...
                'auto_migrate': True,
                'symbols': user_config.get_value(['data_collection', 'real_time', 'symbols'], []),
                ...
                'min_coverage_days': user_config.get_value(['data_collection', 'historical', 'min_coverage_days'], 365)
            }
